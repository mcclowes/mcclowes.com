...
The goal isn't to replace JavaScript or Python everywhere. It's to make certain kinds of code dramatically more readable and reliable.
...
If you're curious, check out the [GitHub repo](https://github.com/mcclowes/lea) or use [the playground](https://lea.mcclowes.com/). Run the REPL. Try writing some pipelines. Let me know what you think.
