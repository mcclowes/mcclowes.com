---
title: The 4Ps of good business
description: A framework for building businesses that endure
---

<div className="printable-page">

# The 4Ps of good business

Each P needs to be in place, in order, or you're doomed.

---

## The framework

<div className="framework-grid framework-numbered">
...
**Diagnosis:** When something feels off, work through the Ps in order. Problems at lower levels (Purpose, People) will manifest as symptoms at higher levels (Process, Product).

**Building:** Start with Purpose. Get that right before hiring. Get People right before formalizing Process. Get Process right before scaling Product.

**Assessment:** Score each P 1-5. The lowest score is your constraint—fix it before optimizing others.

---

<div className="framework-footer">

**The 4Ps of Good Business** by [mcclowes](https://mcclowes.com)
Read more: [mcclowes.com/blog/4-ps-of-good-business](https://mcclowes.com/blog/2024/11/21/4-ps-of-good-business)
